...
import saveAccountsLwc from '@salesforce/apex/AccountController.saveAccountsLwc';
import getAccounts from '@salesforce/apex/AccountController.getAccounts';
import deleteAccounts from '@salesforce/apex/AccountController.deleteAccounts';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';


export default class InlineEditCustomDataTable extends LightningElement {
    ...
    getAccountRecords() {
        getAccounts()
            .then(result => {
                ...
                console.log('this.myList--:'+JSON.stringify(this.myList));
                this.error = undefined;
            })
            .catch(error => {
                this.error = error;
